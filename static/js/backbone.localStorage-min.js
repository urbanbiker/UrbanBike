...
<meta content="3NBZR8wbQGh7pmcsPC+qn4Bz7X+tInrO/pvZEnU+T9o=" name="csrf-token" />
    ...
    <script defer="true" src="https://a248.e.akamai.net/assets.github.com/javascripts/bundles/github-c918997d6ed57474a0a76c3b00c3afbc44225438.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/jeromegn/Backbone.localStorage/blob/2d02329371535938685f2c84feedcd91a052b182/backbone.localStorage-min.js'>
...
<form accept-charset="UTF-8" action="/search" id="top_search_form" method="get"><input name="utf8" type="hidden" value="&#x2713;" />        <a href="/search" class="advanced-search tooltipped downwards" title="Advanced Search"><span class="mini-icon advanced-search"></span></a>
  ...
  <div id="userbox">
    <div id="user">
      <a href="https://github.com/aschem"><img height="20" src="https://secure.gravatar.com/avatar/5d084b6073c225f1baa39d737a6251a4?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-140.png" width="20" /></a>
      <a href="https://github.com/aschem" class="name">aschem</a>
    </div>
    <ul id="user-links">
      <li>
      ...
      <div class="container hentry">
        ...
        <div class="title-actions-bar">
          ...
          <li class="js-toggler-container watch-button-container ">
            <a href="/jeromegn/Backbone.localStorage/toggle_watch" class="minibutton btn-watch watch-button js-toggler-target" data-method="post" data-remote="true" rel="nofollow"><span><span class="icon"></span>Watch</span></a>
            <a href="/jeromegn/Backbone.localStorage/toggle_watch" class="minibutton btn-watch unwatch-button js-toggler-target" data-method="post" data-remote="true" rel="nofollow"><span><span class="icon"></span>Unwatch</span></a>
          </li>

              <li><a href="/jeromegn/Backbone.localStorage/fork" class="minibutton btn-fork fork-button" data-method="post" rel="nofollow"><span><span class="icon"></span>Fork</span></a></li>
      ...
      <li class="repostats">
        <ul class="repo-stats">
          <li class="watchers ">
            <a href="/jeromegn/Backbone.localStorage/watchers" title="Watchers" class="tooltipped downwards">
              312
            </a>
          </li>
          <li class="forks">
            <a href="/jeromegn/Backbone.localStorage/network" title="Forks" class="tooltipped downwards">
              83
            </a>
          </li>
        </ul>
...
<a href="/jeromegn" class="url fn" itemprop="url" rel="author">              <span itemprop="title">jeromegn</span>
              </a></span> /
  ...
  <ul class="tabs">
    ...
    <li><a href="/jeromegn/Backbone.localStorage/network" highlight="repo_network">Network</a>
    <li><a href="/jeromegn/Backbone.localStorage/pulls" highlight="repo_pulls">Pull Requests <span class='counter'>3</span></a></li>

      <li><a href="/jeromegn/Backbone.localStorage/issues" highlight="repo_issues">Issues <span class='counter'>9</span></a></li>


    <li><a href="/jeromegn/Backbone.localStorage/graphs" highlight="repo_graphsrepo_contributors">Stats &amp; Graphs</a></li>

  </ul>
 
<div class="frame frame-center tree-finder" style="display:none"
      data-tree-list-url="/jeromegn/Backbone.localStorage/tree-list/2d02329371535938685f2c84feedcd91a052b182"
      data-blob-url-prefix="/jeromegn/Backbone.localStorage/blob/2d02329371535938685f2c84feedcd91a052b182"
    >
...
<div class="subnav-bar">
  ...
  <ul class="actions subnav">
    <li><a href="/jeromegn/Backbone.localStorage/tags" class="blank" highlight="repo_tags">Tags <span class="counter">0</span></a></li>
    <li><a href="/jeromegn/Backbone.localStorage/downloads" class="blank downloads-blank" highlight="repo_downloads">Downloads <span class="counter">0</span></a></li>
          ...
          <div class="context-body pane-selector commitish-selector js-filterable-commitishes">
            <div class="filterbar">
              ...
              <div class="commitish-item branch-commitish selector-item">
                <h4>
                    <a href="/jeromegn/Backbone.localStorage/blob/master/backbone.localStorage-min.js" data-name="master" rel="nofollow">master</a>
                </h4>
              </div>
  ...
  <ul class="subnav with-scope">
    ...
    <li><a href="/jeromegn/Backbone.localStorage" class="selected" highlight="repo_source">Files</a></li>
    <li><a href="/jeromegn/Backbone.localStorage/commits/master" highlight="repo_commits">Commits</a></li>
    <li><a href="/jeromegn/Backbone.localStorage/branches" class="" highlight="repo_branches" rel="nofollow">Branches <span class="counter">1</span></a></li>
  </ul>
...
<!-- block_view_fragment_key: views7/v8/blob:v21:e27b3bcbcb3f00e90caae4ca90cbba62 -->
  <div id="slider">

    <div class="breadcrumb" data-path="backbone.localStorage-min.js/">
      <b itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/jeromegn/Backbone.localStorage/tree/2d02329371535938685f2c84feedcd91a052b182" class="js-rewrite-sha" itemprop="url"><span itemprop="title">Backbone.localStorage</span></a></b> / <strong class="final-path">backbone.localStorage-min.js</strong> <span class="js-clippy mini-icon clippy " data-clipboard-text="backbone.localStorage-min.js" data-copied-hint="copied!" data-copy-hint="copy to clipboard"></span>
    </div>


      <div class="commit file-history-tease" data-path="backbone.localStorage-min.js/">
        <img class="main-avatar" height="24" src="https://secure.gravatar.com/avatar/d309ddb80e1e28e6f8e3a9685d1f8b29?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-140.png" width="24" />
        <span class="author"><a href="/erichmenge">erichmenge</a></span>
        <time class="js-relative-date " datetime="2012-03-29T08:56:42-07:00" title="2012-03-29 08:56:42">March 29, 2012</time>
        <div class="commit-title">
            <a href="/jeromegn/Backbone.localStorage/commit/66ac3da1b3ba187a196f10ca1b5adfc5d5b154f9" class="message">Create minified version.</a>
        </div>

        <div class="participation">
          <p class="quickstat"><a href="#blob_contributors_box" rel="facebox"><strong>2</strong> contributors</a></p>
              <a class="avatar tooltipped downwards" title="jeromegn" href="/jeromegn/Backbone.localStorage/commits/master/backbone.localStorage-min.js?author=jeromegn"><img height="20" src="https://secure.gravatar.com/avatar/c96dbcc746d551ea0665da4a23536280?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-140.png" width="20" /></a>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="backbone.localStorage-min.js/" data-permalink-url="/jeromegn/Backbone.localStorage/blob/2d02329371535938685f2c84feedcd91a052b182/backbone.localStorage-min.js" data-title="Backbone.localStorage/backbone.localStorage-min.js at master · jeromegn/Backbone.localStorage · GitHub" data-type="blob">
          ...
          <div class="file">
            <div class="meta">
              ...
              <ul class="button-group actions">
                  <li>
                    <a class="grouped-button file-edit-link minibutton bigger lighter js-rewrite-sha" href="/jeromegn/Backbone.localStorage/edit/2d02329371535938685f2c84feedcd91a052b182/backbone.localStorage-min.js" data-method="post" rel="nofollow"><span>Edit this file</span></a>
                  </li>

                <li>
                  <a href="/jeromegn/Backbone.localStorage/raw/master/backbone.localStorage-min.js" class="minibutton btn-raw grouped-button bigger lighter" id="raw-url"><span><span class="icon"></span>Raw</span></a>
                </li>
                  <li>
                    <a href="/jeromegn/Backbone.localStorage/blame/master/backbone.localStorage-min.js" class="minibutton btn-blame grouped-button bigger lighter"><span><span class="icon"></span>Blame</span></a>
                  </li>
                <li>
                  <a href="/jeromegn/Backbone.localStorage/commits/master/backbone.localStorage-min.js" class="minibutton btn-history grouped-button bigger lighter" rel="nofollow"><span><span class="icon"></span>History</span></a>
                </li>
              </ul>
            </div>
...
<div class="frame frame-loading large-loading-area" style="display:none;" data-tree-list-url="/jeromegn/Backbone.localStorage/tree-list/2d02329371535938685f2c84feedcd91a052b182" data-blob-url-prefix="/jeromegn/Backbone.localStorage/blob/2d02329371535938685f2c84feedcd91a052b182">
...
<div class="lower_footer">
  <div class="container clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2012 <span title="0.07447s from fe11.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.07685' data-host='fe11'></span>
  </body>
</html>
